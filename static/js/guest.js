...
//    FULLY FIXED – Consistent guest count, no more 0/8 bug
//    ============================================================== */

//    let guests = []; // Ensure this is declared at the top if not already
//    const MAX_GUESTS = 8;
...
//        loadGuestsForDialog(); // Loads full list and updates UI correctly
//    }
...
//        // Update UI consistently using local data
//        updateGuestList();
//        updateGuestCounter();
...
//                updateGuestList();
//                renderGuestCountInMain();
//                console.log(`Loaded ${guests.length} guests from server`);
//            }
//        } catch (e) {
...
//                updateGuestList();
//                updateGuestCounter();
//                renderGuestCountInMain(); // Ensure main page is also updated
//            }
//        } catch (e) {
...
//        }
//        // No need to fetch count back — we trust local guests.length
//    }
...
//    /* Optional: Call this on page load to initialize */
//    document.addEventListener('DOMContentLoaded', () => {
//        loadGuestsFromServer(); // Ensures main page shows correct count on load
//    });